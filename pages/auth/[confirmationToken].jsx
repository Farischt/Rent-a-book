...
export default function ConfirmAccount({ first_name, email }) {
  return (
    <div className="fixed z-10 inset-0 overflow-y-auto">
      <Head>
        <title>Efrei Books - Confirmation </title>
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity">
          ...
          <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
            ...
            <div className="mt-5 sm:mt-6">
              <Link href="/auth">
                <a className="inline-flex justify-center w-full rounded-md border border-transparent shadow-sm px-4 py-2 bg-primary text-base font-medium text-white hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary sm:text-sm">
                  Connexion
                </a>
              </Link>
            </div>
