...
const people = [
  {
    name: "Faris Chtatou",
    role: "Fullstack Lead Developper",
    imageUrl: "/faris.jpg",
    twitterUrl: "https://www.linkedin.com/in/farischtatou1999/",
    linkedinUrl: "https://www.linkedin.com/in/farischtatou1999/",
  },
  {
    name: "Yoni Feldman",
  ...
  return (
    <Layout title="Home page" user={user}>
          ...
          {!user && (
            <>
              <p className="mt-4 text-lg leading-6 text-indigo-200">
                Vous êtes étudiants à l'Efrei ? Empruntez vos livres sur la
      ...
      <div className="bg-white">
        <div className="mx-auto py-12 px-4 max-w-7xl sm:px-6 lg:px- lg:py-24">
          <div className="space-y-12">
            <div className="space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none">
              ...
              <p className="text-xl text-gray-500 text-center">
                Nous sommes trois étudiants à Efrei Paris en Master 1, au sein
                de la fillière IT !
              </p>
            </div>
            <ul
